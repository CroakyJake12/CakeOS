...
public sealed class PreviewWindow : Window
{
    ...
    public PreviewWindow(IRootElement? root)
    {
        ...
        var scene = HuiDemoScene.Build(
            "CAKEOS / HUI WINDOWS BACKEND",
            "A real HUI scene, rendered as a Windows desktop window.",
        ...
        _surface = new HuiAppSurface(scene.Root,
            new HuiSurfaceServices(backend), HavenPlatform.Windows);
    ...
    /// <summary>Hosts the real Canvas application (HUI tree + Rnote engine).</summary>
